(component $counter-note
  ...
  (type (;2;)
    (instance
      (alias outer $counter-note 1 (type (;0;)))
      (export (;1;) "felt" (type (eq 0)))
  ...
  (core module (;0;)
    ...
    (import "miden:core-intrinsics/intrinsics-mem@1.0.0" "heap-base" (func $miden_sdk_alloc::heap_base (;5;) (type 4)))
    (table (;0;) 3 3 funcref)
    (memory (;0;) 17)
    ...
    (elem (;0;) (i32.const 1) func $counter_note::bindings::__link_custom_section_describing_imports $cabi_realloc)
    (func $__wasm_call_ctors (;6;) (type 5))
    (func $counter_note::bindings::__link_custom_section_describing_imports (;7;) (type 5))
    ...
    (func $__rustc::__rust_realloc (;9;) (type 7) (param i32 i32 i32 i32) (result i32)
      block ;; label = @1
        i32.const 1048620
        local.get 2
        local.get 3
    ...
    (func $core::ptr::alignment::Alignment::max (;15;) (type 6) (param i32 i32) (result i32)
      local.get 0
      local.get 1
      local.get 0
      local.get 1
    ...
    (func $cabi_realloc (;16;) (type 7) (param i32 i32 i32 i32) (result i32)
      local.get 0
      local.get 1
      local.get 2
      local.get 3
  ...
  (alias export 3 "add" (func (;3;)))
  (core func (;3;) (canon lower (func 3)))
  (alias export 3 "assert-eq" (func (;4;)))
  ...
  (alias export 2 "heap-base" (func (;5;)))
  (core func (;5;) (canon lower (func 5)))
  (core instance (;2;)
    (export "heap-base" (func 5))
  )
  ...
  (type (;5;) (func))
  (alias core export 3 "miden:base/note-script@1.0.0#note-script" (core func (;6;)))
