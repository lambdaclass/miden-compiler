...
//! # Introduction
//!
//! `midenc_expect_test` is a small addition over plain `assert_eq!` testing approach,
...
//! # Suggested Workflows
//!
//! I like to use data-driven tests with `midenc_expect_test`. I usually define a
